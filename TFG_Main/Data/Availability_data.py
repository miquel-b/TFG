...
data={
        "Activity type": ["Production", "Complete Cleaning", "Format Changeover", "Batch Change", "Others"],
        "Production Times (h)": [2.3459*24,2.3255*24,0.4691*24,0.2653*24,0.2369*24]}
...
palette = sns.color_palette("deep", len(df))  # Try "magma", "crest", etc. for different looks
...
barplot = sns.barplot(
    ...
    color='black', edgecolor="black",width=bar_width, ax=ax1
)
